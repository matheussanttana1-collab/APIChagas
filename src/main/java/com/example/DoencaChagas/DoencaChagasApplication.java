...
public class DoencaChagasApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(DoencaChagasApplication.class, args);
	}

	@Bean
	public CommandLineRunner run(SistemaService sistemaService, BancoDeDadosDAO bancoDeDadosDAO) {
		return args -> {
	...
	private void adicionarOcorrencia(Scanner scanner, SistemaService sistemaService) {
		...
		try {
			...
			Paciente p = sistemaService.adicionarOcorrencia(idade, sexo, faseDoenca, formaClinica, viaTransmissao, statusPaciente, cidade);
